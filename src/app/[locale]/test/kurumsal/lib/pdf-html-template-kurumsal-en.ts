// Growtify AI — Corporate Quiz PDF Template (Puppeteer)
...
const PERSONA_INFO: Record<KurumsalPersona, { icon: string; iconBg: string; subtitle: string; desc: string }> = {
  Baslangic: {
    ...
    desc: "Your organization is at the start of its AI journey. With the right foundations in place, the potential for fast progress is high.",
  },
  Kesif: {
    icon: ICONS.search("#fff"), iconBg: "#F59E0B",
    subtitle: "AI Experimentation Stage",
    desc: "You're trying out AI tools but a systematic approach is missing. With the right roadmap, you can accelerate.",
  },
  Uygulama: {
    icon: ICONS.gear("#fff"), iconBg: "#2563EB",
    subtitle: "AI Operations Stage",
    desc: "AI solutions are actively in use. It's time to focus on scaling and governance.",
  },
  Lider: {
    icon: ICONS.rocket("#fff"), iconBg: "#7C3AED",
    subtitle: "AI Transformation Stage",
    desc: "AI is being used as a strategic competitive advantage. It's time to explore new opportunities.",
  },
};
...
const SECTOR_LABELS: Record<string, string> = {
  saas: "SaaS & Technology", eticaret: "E-Commerce & Retail",
  finans: "Finance & Banking", saglik: "Healthcare & Pharma",
  hukuk: "Legal & Consulting", uretim: "Manufacturing & Logistics",
  egitim: "Education", diger: "Other",
};

const GOAL_LABELS: Record<string, string> = {
  verimlilik: "Operational efficiency", gelir: "Revenue growth",
  maliyet: "Cost reduction", deneyim: "Customer experience",
  rekabet: "Competitive advantage",
};

const DEPT_LABELS: Record<string, string> = {
  pazarlama: "Marketing", satis: "Sales", musteri_hizmetleri: "Customer Service",
  finans: "Finance", operasyon: "Operations", ik: "Human Resources", it: "IT",
};
...
<div class="page" style="background:white;">
  <div class="p1-header">
    <div class="p1-badge">Corporate Report</div>
    <div class="p1-title">AI Maturity Assessment Report</div>
    <div class="p1-subtitle">Your organization's AI readiness level</div>
  ...
  <div class="p1-body">
    ...
    <div class="score-row">
      <div class="score-card score-card-primary" style="flex:1.5">
        ...
        <div class="score-label">Average Maturity</div>
      </div>
    ...
    <!-- 5 Dimension Bars -->
    <div class="section-title">AI Maturity Across 5 Dimensions</div>
    <div class="section-sub">Score out of 10 — higher values indicate higher maturity</div>
    ${dimensions.map((d) => {
    ...
    <div style="margin-top:24px;">
      <div class="section-title" style="font-size:14px;">Challenge Areas</div>
      <div class="section-sub">Out of 5 — higher values indicate greater challenges</div>
      <div class="pain-grid">
        ${pains.map((p) => `
        <div class="pain-card">
    ...
    <div class="details-grid">
      ...
      <div class="detail-box">
        ...
        <div class="detail-val">${esc(state.companySize ?? "Not specified")}</div>
      </div>
      <div class="detail-box">
      ...
      <div class="detail-box">
        ...
        <div class="detail-val">${state.q_priority_depts?.length ?? 0} departments</div>
      </div>
    </div>

    ${state.q_priority_depts?.length ? `
    <div style="margin-top:16px;">
      <div style="font-size:12px; font-weight:700; color:${DARK}; margin-bottom:8px;">Priority Departments</div>
      <div class="dept-tags">
  ...
  <div class="p1-footer">This report is an automated analysis based on your responses to the Growtify.ai Corporate AI Maturity Assessment. It does not constitute professional, legal, or financial advice. Results are based on the answers provided and are not an objective measurement. Your personal data is processed under applicable data protection regulations. © ${new Date().getFullYear()} Growtify — growtify.ai</div>
</div>
...
<div class="page p2" style="position:relative;">
  <div class="p2-header">
    ...
    <div class="p2-pagetitle">${esc(state.firstName)} — Corporate AI Maturity Analysis</div>
  </div>
  ...
  <div class="persona-card">
    ...
    <div class="persona-sub">${esc(state.persona === "Baslangic" ? "Awareness" : state.persona === "Kesif" ? "Exploration" : state.persona === "Uygulama" ? "Implementation" : "Leader")} Level</div>
  ...
  <div style="margin-top:12px; margin-bottom:20px;">
    <div class="rec-box">
      ...
      <div>
        <div class="rec-title">AI Strategy Assessment</div>
        <div class="rec-body">Let's begin with a free 30-minute strategy session. Together we'll review your team, your goals, and where you stand today.</div>
      </div>
    </div>
    <div class="rec-box">
      ...
      <div>
        <div class="rec-title">ROI Measurement Framework</div>
        <div class="rec-body">We'll show you how to build a systematic structure to measure the return on your AI investments.</div>
      </div>
    </div>
    <div class="rec-box">
      ...
      <div>
        <div class="rec-title">Team Capability Map</div>
        <div class="rec-body">Map your team's AI capabilities and identify their training needs.</div>
      </div>
    </div>
  </div>
  ...
  <div style="background:#f8fafc; border-radius:16px; padding:20px; margin-bottom:20px;">
    <div style="font-size:13px; font-weight:800; color:${DARK}; margin-bottom:12px;">Transformation with the GROWT Method</div>
  ...
  <!-- CTA -->
  <div class="cta-bar">
    <div class="cta-name">Free Strategy Session</div>
    <div class="cta-sub">A 30-minute discovery call — your team, your goals, and your roadmap</div>
    <a href="https://app.growtify.app/widget/bookings/kurumsal-on-gorusme" class="cta-btn" style="text-decoration:none;color:${PRIMARY};">Book a Session &rarr;</a>
