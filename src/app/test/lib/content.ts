...
const declare: ScreenConfig[] = [
  ...
  },
  {
    ...
    options: [
      { value: "pazarlama", label: "Pazarlama Süreçleri" },
      { value: "satis", label: "Satış Süreçleri" },
      { value: "musteri", label: "Müşteri İletişimi" },
      { value: "operasyon", label: "Operasyonel Otomasyon" },
      { value: "finans", label: "Finans ve Muhasebe" },
      { value: "strateji", label: "Strateji ve Analiz" },
      { value: "personel", label: "Personel ve Çalışan Takibi" },
      { value: "egitim", label: "Eğitim & Danışan Materyalleri" },
    ],
  },
  {
    id: 20,
